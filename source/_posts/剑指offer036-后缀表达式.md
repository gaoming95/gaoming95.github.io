...
<div><div>Related Topics</div><div><li>栈</li><li>数组</li><li>数学</li></div></div><br><div><li>👍 11</li><li>👎 0</li></div>

## 思路

栈的问题，当不是操作符时入栈，是操作符时，取出栈顶的两个元素，将计算结果再压入栈中
...
class Solution {
    ...
    public int evalRPN(String[] tokens) {
        Set<String> operatorSet = new HashSet<>(4);
        operatorSet.add("+");
        operatorSet.add("-");
        operatorSet.add("*");
        operatorSet.add("/");
